...
<main>
    <div class="container mt-5">
        <div>
            <h1><strong>Enter the new technology details</strong></h1>
        </div>
        <form action="{{route('technologies.store')}}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Insert the name of the technology">
            </div>
            <div class="mb-3">
